...
const CommentForm = (props: Props) => {
    const { register, handleSubmit, formState, formState: { errors, isSubmitSuccessful }, reset } = useForm<CommentFormInputs>({ resolver: yupResolver(validation) });
  ...
  return (
    <form className="mt-4 ml-4 w-full" onSubmit={handleSubmit(props.handleComment)}>
      <input
        type="text"
        id="title"
